...
Была проведена работа по разработке системы, обеспечивающей реализацию, тестирование и анализ производительности алгоритма AHU для идентификации изоморфных деревьев. 
# Список источников
